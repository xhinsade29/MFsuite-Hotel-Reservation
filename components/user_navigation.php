...
?>
<!-- USER NAVIGATION BAR COMPONENT: Include this inside <body> of your main page -->
...
<nav class="navbar">
    <div class="nav-container">
        ...
        <div class="nav-right">
            ...
            <button class="profile-trigger" id="profileDropdownBtn" type="button">
...
document.addEventListener('DOMContentLoaded', function() {
    // Notification dropdown logic (if any)
    ...
    if (profileBtn && profileDropdown) {
        profileBtn.addEventListener('click', function(e) {
            e.stopPropagation();
            const willShow = profileDropdown.style.display !== 'block';
            profileDropdown.style.display = willShow ? 'block' : 'none';
        });
        document.addEventListener('click', function(e) {
