...
// Handle add, edit, delete actions for rooms and services
$msg = '';
...
<head>
    ...
    <title>Admin Amenities - MF Suites Hotel</title>
    ...
    <style>
        ...
        .edit-form, .edit-service-form { display: none; }
...
<div class="container">
    <div class="title">Amenities Management</div>
    <?php if ($msg): ?>
    ...
    <ul class="nav nav-tabs mb-4" id="amenitiesTab" role="tablist">
      <li class="nav-item" role="presentation">
        <button class="nav-link active" id="rooms-tab" data-bs-toggle="tab" data-bs-target="#roomTableSection" type="button" role="tab" aria-controls="roomTableSection" aria-selected="true">Room Types</button>
      </li>
      <li class="nav-item" role="presentation">
        <button class="nav-link" id="services-tab" data-bs-toggle="tab" data-bs-target="#serviceTableSection" type="button" role="tab" aria-controls="serviceTableSection" aria-selected="false">Services</button>
      </li>
    </ul>
    <div class="tab-content">
      <div class="tab-pane fade show active" id="roomTableSection" role="tabpanel" aria-labelledby="rooms-tab">
      ...
      <div class="tab-pane fade" id="serviceTableSection" role="tabpanel" aria-labelledby="services-tab">
